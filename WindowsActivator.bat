...
if %errorlevel%==0 (
    ...
    ) else if "%os_caption%"=="Windows 10 Education N" (
    ...
    ) else if "%os_caption%"=="Windows 10 Pro Education N" (
    ...
    ) else if "%os_caption%"=="Windows 10 Enterprise G" (
        set KMS_KEY=YYVX9-NTFWV-6MDM3-9PT4T-4M68B
    ) else if "%os_caption%"=="Windows 10 Enterprise G N" (
        set KMS_KEY=44RPN-FTY23-9VTTB-MP9BX-T84FV
    ) else if "%os_caption%"=="Windows 10 Enterprise LTSB 2016" (
    ...
    if "%os_caption%"=="Windows Server 2016 Datacenter" (
        set KMS_KEY=CB7KF-BWN84-R7R2Y-793K2-8XDDG
    ) else if "%os_caption%"=="Windows Server 2016 Standard" (
        set KMS_KEY=WC2BQ-8NRM3-FDDYY-2BFGV-KHKQY
    ) else if "%os_caption%"=="Windows Server 2016 Essentials" (
        set KMS_KEY=JCKRF-N37P4-C2D82-9YXRT-4M63B
    ) else if "%os_caption%"=="Windows Server 2019 Datacenter" (
        set KMS_KEY=WMDGN-G9PQG-XVVXX-R3X43-63DFG
    ) else if "%os_caption%"=="Windows Server 2019 Standard" (
        set KMS_KEY=N69G4-B89J2-4G8F4-WWYCC-J464C
    ) else if "%os_caption%"=="Windows Server 2019 Essentials" (
